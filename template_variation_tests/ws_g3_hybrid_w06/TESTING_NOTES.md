...
- `01_ws_g3_hybrid_w06_blank_original.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 0/10
- `02_ws_g3_hybrid_w06_fully_filled_correct.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 6/10
  - Review regions: q7a, q7b, q8a, q8b
- `03_ws_g3_hybrid_w06_fully_filled_incorrect.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 0/10
  - Review regions: q7a, q7b, q8a, q8b
- `04_ws_g3_hybrid_w06_half_filled_correct.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 5/10
- `05_ws_g3_hybrid_w06_alternate_filled_correct.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 3/10
  - Review regions: q7a, q8a
- `06_ws_g3_hybrid_w06_mcq_only_correct.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 6/10
- `07_ws_g3_hybrid_w06_open_only_correct.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 0/10
  - Review regions: q7a, q7b, q8a, q8b
- `08_ws_g3_hybrid_w06_multiple_marks.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 0/10
  - Review regions: q1, q2, q3, q4, q5, q6
- `09_ws_g3_hybrid_w06_stray_marks.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment from full-frame/cropped input
  - Score: 6/10
  - Review regions: q7a, q7b, q8a, q8b
- `10_ws_g3_hybrid_w06_tedha_rotated.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: page contour perspective correction + ORB refinement
  - Score: 6/10
  - Review regions: q7a, q7b, q8a, q8b
- `11_ws_g3_hybrid_w06_perspective_skewed.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: page contour perspective correction + ORB refinement
  - Score: 6/10
  - Review regions: q7a, q7b, q8a, q8b
- `12_ws_g3_hybrid_w06_zoomed_cropped.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `completed`
  - Step 4 normalization: ORB feature homography alignment
  - Score: 6/10
  - Review regions: q7a, q7b, q8a, q8b
- `13_ws_g3_hybrid_w06_blurry.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `failed`
  - Stop/warning step: 3. Image validation and normalisation gate
  - Errors: Image looks blurry. Upload a clearer worksheet photo.
- `14_ws_g3_hybrid_w06_small.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `failed`
  - Stop/warning step: 3. Image validation and normalisation gate
  - Errors: Image resolution is too small for reliable region crops.
- `15_ws_g3_hybrid_w06_too_dark.png`
  - Selected template: `ws_g3_hybrid_w06`
  - Final status: `failed`
  - Stop/warning step: 3. Image validation and normalisation gate
